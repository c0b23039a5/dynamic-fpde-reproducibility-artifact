...
Experimental runner for the FPDE manuscript.

Default target:
    - OpenML-CC18 benchmark suite, suite id 99
    - LightGBM black-box classifier
    - Diff-FPDE, Cos-FPDE, Hyb-FPDE with validation-selected lambda
...
def write_outputs(
    ...
    dataframe_to_latex_table(
        ...
        "Validation scores for Hyb-FPDE lambda candidates.",
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--n-val-select", type=int, default=20, help="Validation instances used to select Hyb-FPDE lambda.")
